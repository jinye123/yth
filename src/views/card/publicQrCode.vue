<template>
  <div class="page-box">
    <div class="open-year-box">
      ...
      <div class="tip-box">
        恭喜你，公开学院年卡已开通成功，<br/>
        你的权益已全部生效，请按以下步骤进行操作
      </div>
      <p class="item-box">
        <span>1.【晋级训练营】</span>
        扫描下方二维码，添加小助手为好友，
        开课前小助手会提前通知你，并拉你进训练营社群
      </p>
      <div class="qr-box">
        <van-image
          width="123px"
      ...
      <p class="item-box">
        <span>2.【课程安排】</span>点击下方按钮，查看晋级训练营课程安排
      </p>
      <div class="btn-box">
        <van-button
          round
      ...
      <p class="item-box">
        <span>3.【公开课程】</span>点击下方按钮，去学习公开学院音/视频 课程
      </p>
      <div class="btn-box">
        <van-button
          round
